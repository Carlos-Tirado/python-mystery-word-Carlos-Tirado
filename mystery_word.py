...
def play_game():
    ...
    with open("words.txt") as open_file: 
        ...
        while len(letters_to_guess) > 0 and opportunities > 0:
            #'/'.join(['A', 'B', 'C']) --> 'A/B/C' this method put together all the elements in that secuence with the carachter inside the quotes
            ...
            #showing Current progress of the word (like DREAM-R)
